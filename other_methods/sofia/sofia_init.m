function [U,X_hat,O,errHist,info] = sofia_init(Y,Omega,R,m,lambda1,lambda2,lambda3,maxEpoch,tol, origin)
...
for epoch = 1:maxEpoch
    ...
    errHist(epoch) = norm(origin(:)-X(:))/norm(origin(:));
    if epoch > 1
